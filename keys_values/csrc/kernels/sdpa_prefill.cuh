...
// Fused prefill launch function declarations (weights accumulated in tiling loop)
template <typename DTypeQ, typename DTypeKV, typename DTypeO>
...
// Fused prefill v2 launch function declarations (no score_cache, K re-read with Q in smem)
template <typename DTypeQ, typename DTypeKV, typename DTypeO>
...
// Weight accumulation function declarations (old two-pass approach)
