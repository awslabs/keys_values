...
if [ "$#" -ne 1 ]; then
    echo "Illegal number of parameters, you should pass the version when calling this script, for instance `bash release.sh 0.1.0`"
fi

version=$1
version_file=keys_values/version
...
python -c "import keys_values; print(keys_values.__version__)"
